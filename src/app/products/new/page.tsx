...
export default function NewProductPage() {
  ...
  const generateSku = () => {
    const prefix = form.category.substring(0, 2).toUpperCase();
    const timestamp = Date.now().toString(36).toUpperCase();
    const random = Math.random().toString(36).substring(2, 5).toUpperCase();
    setForm(prev => ({ ...prev, sku: `${prefix}-${timestamp}-${random}` }));
  };
      ...
      <form onSubmit={handleSubmit} className="space-y-6">
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>产品的基本属性</CardDescription>
          </CardHeader>
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>设置产品的售价和成本</CardDescription>
          </CardHeader>
          <CardContent className="space-y-4">
